...
public class WebConfig implements WebMvcConfigurer {
    ...
    public void addCorsMappings(CorsRegistry registry) {
        registry.addMapping("/**")
                .allowedOrigins("http://localhost:3000", "http://54.180.201.99", "http://13.209.61.108:8080", "http://sooklion-bucket.s3-website.ap-northeast-2.amazonaws.com" )  // 허용할 클라이언트 도메인
